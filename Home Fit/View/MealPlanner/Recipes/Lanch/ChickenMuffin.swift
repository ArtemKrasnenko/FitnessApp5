    ...
    var body: some View {
        HStack {
            ...
            VStack(alignment: .leading) {
                Text("Куриные маффины с шампиньонами")
        ...
        ZStack {
            VStack(alignment: .leading) {
                ...
                Text("Куриные маффины с шампиньонами")
                    ...
                    .padding(.top, 30)
                    .padding(.bottom, 10)
                Text("Такие диетические маффины рекомендуется употреблять на обед при правильном питании людям, которые хотят избавиться от лишнего веса без вреда для здоровья. Этот рецепт способен не только разнообразить меню худеющего человека, но и увлечь правильным питанием всю семью.")
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack {
                        ...
                        Text("Все ингредиенты мелко нарезаем и помещаем в чашу блендера до получения однородной массы.")
                            .font(MontserratRegular_12)
                            .foregroundColor(Color(uiColor: GrayMenu))
                            .padding(.bottom, 10)
                    }
                    ...
                    HStack {
                        ...
                        Text("Полученное пюре выкладываем в формочки для маффинов и запекает в разогретой духовке примерно 30 минут.")
                            .font(MontserratRegular_12)
                            .foregroundColor(Color(uiColor: GrayMenu))
                            .padding(.bottom, 20)
                    }
