...
struct AssortedVegetable: View {
    ...
    var body: some View {
        HStack {
            Image("AssortedVegetable")
                .resizable()
                .frame(width: 117, height: 117, alignment: .leading)
                .padding(.leading, 10)
                .padding(.trailing, 15)
            VStack(alignment: .leading) {
                Text("Ассорти из запеченных овощей")
...
struct AssortedVegetableFunc: View {
...
struct AssortedVegetableView: View {
        ...
        ZStack {
            VStack(alignment: .leading) {
                ...
                Text("Ассорти из запеченных овощей")
                    ...
                    .padding(.top, 30)
                    .padding(.bottom, 10)
                Text("Главная особенность такого ПП-рецепта ужина – возможность использования любых овощей. То есть, можно брать только любимые овощи и готовить их в духовке для необычайно вкусной и легкой вечерней трапезы.")
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack {
                        ...
                        Text("Овощи следует помыть и нарезать.")
                            .font(MontserratRegular_12)
                            .foregroundColor(Color(uiColor: GrayMenu))
                            .padding(.bottom, 10)
                    }
                    HStack {
                        ...
                        Text("Поместить в полиэтиленовый пакет вместе с солью, специями и оливковым маслом.")
                            .font(MontserratRegular_12)
                            .foregroundColor(Color(uiColor: GrayMenu))
                            .padding(.bottom, 10)
                    }
                    HStack {
                        ...
                        Text("Хорошо потрясти пакет, что поможет равномерно распределить масло и пряности по овощам.")
                            .font(MontserratRegular_12)
                            .foregroundColor(Color(uiColor: GrayMenu))
                            .padding(.bottom, 10)
                    }
                    HStack {
                        ...
                        Text("Выложить все на противень и запекать в духовке до готовности.")
                            .font(MontserratRegular_12)
                            .foregroundColor(Color(uiColor: GrayMenu))
                            .padding(.bottom, 20)
                    }
