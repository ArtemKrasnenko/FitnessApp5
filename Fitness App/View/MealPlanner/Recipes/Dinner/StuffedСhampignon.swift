...
struct StuffedСhampignon: View {
    ...
    var body: some View {
        HStack {
            Image("StuffedСhampignon")
                .resizable()
                .frame(width: 117, height: 117, alignment: .leading)
                .padding(.leading, 10)
                .padding(.trailing, 15)
            VStack(alignment: .leading) {
                Text("Фаршированные шампиньоны")
...
struct StuffedСhampignonFunc: View {
...
struct StuffedСhampignonView: View {
        ...
        ZStack {
            VStack(alignment: .leading) {
                ...
                Text("Фаршированные шампиньоны")
                    ...
                    .padding(.top, 30)
                    .padding(.bottom, 10)
                Text("Фаршированные грибы – прекрасный вариант ПП-рецепта для ужина человека, который придерживается принципов правильного питания. Они обладают низкой калорийностью, при этом содержат достаточное количество белка.")
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack {
                        ...
                        Text("Шляпки грибов следует отделить от ножек и зачистить сердцевину. В них потом будет помещаться начинка.")
                            .font(MontserratRegular_12)
                            .foregroundColor(Color(uiColor: GrayMenu))
                            .padding(.bottom, 10)
                    }
                    HStack {
                        ...
                        Text("Ножки грибов мелко нашинковать, то же самое сделать с луком.")
                            .font(MontserratRegular_12)
                            .foregroundColor(Color(uiColor: GrayMenu))
                            .padding(.bottom, 10)
                    }
                    HStack {
                        ...
                        Text("На разогретую сковороду поместить лук и слегка обжарить. ")
                            .font(MontserratRegular_12)
                            .foregroundColor(Color(uiColor: GrayMenu))
                            .padding(.bottom, 10)
                    }
                    HStack {
                        ...
                        Text("К нему добавить грибы и шпинат, посолить, поперчить, тушить несколько минут.")
                            .font(MontserratRegular_12)
                            .foregroundColor(Color(uiColor: GrayMenu))
                            .padding(.bottom, 10)
                    }
                    HStack {
                        ...
                        Text("Затем полученную массу снять с огня, перемешать с рикоттой и выложить в шляпки шампиньонов.")
                            .font(MontserratRegular_12)
                            .foregroundColor(Color(uiColor: GrayMenu))
                            .padding(.bottom, 10)
                    }
                    HStack {
                        ...
                        Text("Готовое блюдо посыпать натертым сыром и отправить в разогретую до 1800 С духовку на 30 минут.")
                            .font(MontserratRegular_12)
                            .foregroundColor(Color(uiColor: GrayMenu))
                            .padding(.bottom, 20)
                    }
