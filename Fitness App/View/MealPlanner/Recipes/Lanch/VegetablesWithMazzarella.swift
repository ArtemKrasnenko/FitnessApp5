...
struct VegetablesWithMazzarella: View {
    ...
    var body: some View {
        HStack {
            Image("VegetablesWithMazzarella")
                .resizable()
                .frame(width: 117, height: 117, alignment: .leading)
                .padding(.leading, 10)
                .padding(.trailing, 15)
            VStack(alignment: .leading) {
                Text("Овощи с моцареллой")
...
struct VegetablesWithMazzarellaFunc: View {
    ...
    func HeaderView() -> some View {
        GeometryReader { proxy in
            ...
            Image("VegetablesWithMazzarellas")
                .resizable()
...
struct VegetablesWithMazzarellaView: View {
        ...
        ZStack {
            VStack(alignment: .leading) {
                ...
                Text("Овощи с моцареллой")
                    ...
                    .padding(.top, 30)
                    .padding(.bottom, 10)
                Text("Баклажаны с помидорами и моцареллой готовятся очень быстро, но при этом имеют отменный вкус. Блюдо обладает невысокой калорийностью, при этом является очень питательным, поэтому прекрасно подойдет для обеда при правильном питании или фитнес-диете.")
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack {
                        ...
                        Text("Кабачки, помидоры и моцареллу нарезать кружками, желательно одинакового размера. ")
                            .font(MontserratRegular_12)
                            .foregroundColor(Color(uiColor: GrayMenu))
                            .padding(.bottom, 10)
                    }
                    HStack {
                        ...
                        Text("Выложите в форму для запекания приготовленные кружочки, полейте оливковым маслом.")
                            .font(MontserratRegular_12)
                            .foregroundColor(Color(uiColor: GrayMenu))
                            .padding(.bottom, 10)
                    }
                    HStack {
                        ...
                        Text("Отправьте в разогретую духовку на 25-30 минут.")
                            .font(MontserratRegular_12)
                            .foregroundColor(Color(uiColor: GrayMenu))
                            .padding(.bottom, 20)
                    }
