        ...
        ZStack {
            VStack(alignment: .leading) {
                ...
                Text("Тыквенный суп-пюре")
                    ...
                    .padding(.top, 30)
                    .padding(.bottom, 10)
                Text("Этот легкий суп состоит из одних достоинств. Полезные свойства тыквы, нежная кремовая консистенция, пряный вкус и простота приготовления - таков этот суп-пюре из тыквы. Он непременно зарядит вас энергией на целый день и прекрасно согреет и насытит в холодные осенние или зимние дни.")
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack {
                        ...
                        Text("На сливочном масле слегка обжарить лук. Добавить тыкву, посолить, приправить и потушить с добавлением небольшого количества воды. Примерно 20 мин.")
                            .font(MontserratRegular_12)
                            .foregroundColor(Color(uiColor: GrayMenu))
                            .padding(.bottom, 10)
                    }
